...
# Use string formatting to produce 1922 Gibson L-5 CES for about $16,035!:

print("{} {} for about ${:,.0f}!".format(year, name, cost))
print(f"{year} {name} for about ${cost:,.0f}!")

# Use a for loop with the range function and string formatting to produce the following right-aligned output (no lists):
#   0
#  50
# 100
# 150
